...
- **[BLUEPRINT.md](./BLUEPRINT.md)** — the full design writeup: routing logic, VRAM management, module structure, config, known limitations. Start here for the "why."
- **[LOGS.md](./LOGS.md)** — real, unedited terminal output from actual test runs, proving the design in BLUEPRINT.md out in practice. Start here for the "does it actually work."
